...
describe('Test1 getStudentIspiti/:idStudenta',function(done){
    it('Odgovarajuci response',function(done){
        chai.request(BAZ_URL).get('/getStudentIspiti/1').end(function(err,res){
...
describe('Test2 getStudentIspiti/:idStudenta',function(done){
...
describe('Test3 getStudentIspiti/:idStudenta',function(done){
...
describe('Test4 getStudentIspiti/:idStudenta',function(done){
...
describe('Test5 getStudentIspiti/:idStudenta',function(done){
...
describe('Test6 getStudentIspiti/:idStudenta',function(done){
...
describe('Test7 getStudentIspiti/:idStudenta',function(done){
...
describe('Test8 getStudentIspiti/:idStudenta',function(done){
...
describe('Test9 getStudentIspiti/:idStudenta',function(done){
...
describe('Test10 getStudentIspiti/:idStudenta',function(done){
...
describe('Test11 getStudentIspiti/:idStudenta',function(done){

...
describe('Test1 getGrupePrijavljivanje/:idPredmet',function(done){
    it('Odgovarajuci response',function(done){
        chai.request(BAZ_URL).get('/getGrupePrijavljivanje/4').end(function(err,res){
...
describe('Test2 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test3 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test4 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test5 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test6 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test7 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test8 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test9 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test10 getGrupePrijavljivanje/:idPredmet',function(done){
...
describe('Test11 getGrupePrijavljivanje/:idPredmet',function(done){

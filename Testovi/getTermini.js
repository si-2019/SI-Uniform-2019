...
describe('Sprint1_US26 Test1 getTermini/:idStudenta',function(done){
    it('Odgovarajuci response',function(done){
        chai.request(BAZ_URL).get('/getTermini/1').end(function(err,res){
...
describe('Sprint1_US26 Test2 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test3 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test4 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test5 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test6 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test7 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test8 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test9 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test10 getTermini/:idStudenta',function(done){
...
describe('Sprint1_US26 Test11 getTermini/:idStudenta',function(done){
